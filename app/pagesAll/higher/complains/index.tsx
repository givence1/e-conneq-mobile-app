  ...
  const renderContent = () => {
    ...
    return (
      <FlatList
        ...
        renderItem={({ item }) => (
          <Display data={[item]} setShowDetail={setShowDetail} />
        )}
        ListEmptyComponent={
          <Text style={styles.emptyText}>
            {capitalizeEachWord(t("no complaints yet"))}
          </Text>
        }
...
const GET_DATA = gql`
  query GetStudentComplains($customuserId: Decimal!) {

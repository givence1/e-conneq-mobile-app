...
const Display = (
    { loading, error, courses, setShowDetail, apiYears }:
        { loading: boolean, error: any, courses: EdgeCourse[], setShowDetail: any, apiYears: string[] }
) => {
...
function renderTable(courses: EdgeCourse[], setShowDetail: any, t: any) {
        ...
        <View style={styles.table}>
            <View style={styles.headerRow}>
                ...
                <Text style={[styles.cell, styles.headerCell, { flex: 2 }]}>
                    {capitalizeEachWord(t("courses.table.view"))}
                </Text>
            </View>
            ...
            {courses?.map((course, index) => (
                ...
                >
                    ...
                    <View style={[styles.cell, { flex: 2, justifyContent: "center", alignItems: "center" }]}>
                        <TouchableOpacity
                            onPress={() => setShowDetail({ show: true, selectedItem: course.node })}
                        >
